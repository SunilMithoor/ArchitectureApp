...
fun MovieDetailsScreen(
    ...
    val favoriteIcon = if (state.isFavorite) AppDrawable.ic_favorite_fill_white_48 else AppDrawable.ic_favorite_border_white_48
...
private fun MovieItemPlaceholder() {
    Image(
        painter = painterResource(id = AppDrawable.bg_image),
        contentDescription = "",
        contentScale = ContentScale.Crop,
    )
}
